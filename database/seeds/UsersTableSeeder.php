...
use App\Models\User; // 使用 use 关键词引入必要的类
...
class UsersTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // 生成数据集合 factory(User::class) 根据指定的 User 生成模型工厂构造器，对应加载 UserFactory.php 中的工厂设置
        ...
        $user->avatar = 'https://cdn.learnku.com/uploads/images/201710/14/1/ZqM7iaP4CR.png'; // 老头子的头像
        $user->save();
    }
}
